...
- 🛠️ Passionné par l'architecture des systèmes distribués et le déploiement de modèles de Deep Learning.
- 💻 Je maîtrise le développement **Fullstack** (React / JEE / Python).
- ☁️ Focus actuel : Optimisation des pipelines CI/CD et Cloud Native Computing.
...
![JEE](https://img.shields.io/badge/JEE-0073B7?style=flat&logo=java&logoColor=white)
...
![TSQL](https://img.shields.io/badge/T--SQL-0078D4?style=flat&logo=microsoft-sql-server&logoColor=white)
